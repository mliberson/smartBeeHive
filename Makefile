...
OBJECTS    = lcd\serial.o i2c\i2c.o lcd\lcd.o adc\adc.o eeprom\eeprom.o DHT11\DHT11.o optimize\optimize.o HX711-master\HX711.o uv\uv.o rotary_encoder\rotary_encoder.o top.o
